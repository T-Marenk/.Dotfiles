...
xplr.config.modes.builtin.default.key_bindings.on_key["ö"] =
    xplr.config.modes.builtin.default.key_bindings.on_key[":"]
...
require("nuke").setup{
  open = {
    custom = {
      { extension = "pdf", command = "okular {}" },
      { extension = "kitsas", command = "kits {}" },
      { extension = "jpg", command = "gwenview {}" },
      { extension = "JPG", command = "gwenview {}" },
      { extension = "png", command = "gwenview {}" },
      { extension = "md", command = "ls *.md | entr -c glow {}"}
    }
  }
}
